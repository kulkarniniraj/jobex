...
def get_friends_div():
    ...
    return Div(
        ...
        *[
        ...
        Div(
            Div(
                Span("John Doe", cls="font-medium text-gray-700"),
                    ...
                    Select(
                        *[
                            Option(skl.name, value=f"{skl.id}", 
                                   selected=(skl.id in skills_in)) for skl in skills
                        ],
                        id="tags",
                        name="tags",
                        cls="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500",
        ...
        Div(
            ...
            Form(
                ...
                Div(
                    ...
                    Select(
                        *[
                            Option(skl.name, value=f"{skl.id}") for skl in skills
                        ],
                        id="tags",
                        name="tags",
                        cls="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500",
